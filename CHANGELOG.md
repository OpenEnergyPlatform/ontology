...
- boiler (#2226)
- change axioms: `combustion thermal energy transformation`, `combustion-based heater`, `electric motor`, `energy transformation`, `geothermal heat unit`, `geothermal heat transfer`, `internal combustion engine`, `motor`, `renewable power unit`, `heat transfer`, `sensible heat storage object`, `energy storage object` (#2233)
