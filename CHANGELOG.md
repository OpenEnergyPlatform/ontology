...
- boiler (#2226)
- change axioms: `combustion thermal energy transformation`, `combustion-based heater`, `electric motor`, `energy transformation`, `geothermal heat unit`, `geothermal heat transfer` (#2233)
